...
fn lumia_kt_func_0_invoke(
    kt_func_0_raw_as_i8_16: Instance,
    ...
    let kt_func_0: *mut dyn Fn() -> Instance =
        unsafe { transmute(kt_func_0_raw) };
    let value = unsafe { (*kt_func_0)() };
    Ok(value)
}

pub struct KtFunc0<'a, R: GetEnvTrait + FromInstance, >
